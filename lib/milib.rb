def numero_a_palabras(numero, unos = false)
  ...
  palabras = palabras.compact.reverse.join(' ')

  palabras = "uno" if unos && palabras == "un"
...
def centena_a_palabras(numero)
  ...
  centenas = [nil, 'ciento', 'doscientos', 'trescientos', 'cuatrocientos', 'quinientos',
              'seiscientos', 'setecientos', 'ochocientos', 'novecientos']
  decenas = [nil, 'dieci', 'veinti', 'treinta', 'cuarenta', 'cincuenta',
